                ...
                <div class="col-lg-9 blog-post-single">
                    <div class="blog-item">
						<div class="image-blog">
							<img src="{{asset($data->image_one)}}" alt="" class="img-fluid" style="height: 500px;">
						</div>
						<div class="post-content">
							<div class="meta-info-blog">
								<span><i class="fa fa-calendar"></i> <a href="#">{{$data->created_at}}</a> </span>
								<span><i class="fa fa-tag"></i>  <a href="#">{{$data->newscat->newscat_name}}</a> </span>
							...
							<div class="blog-title">
								<h2><a href="#" title="">{{$data->news_tittle}}</a></h2>
							</div>
							<div class="blog-desc">
